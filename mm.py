...
def start_attack_reply(message, target, port, time):
    ...
    response = f"🔥{username}, BABY ATTACK LAUNCHED🔥.\n\n🎯ATTACKED IP ==): {target}\n\n🔌ATTACKED PORT ==): {port}\n\n⏱️ATTACKED TIME ==): {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @SIDIKI_MUSTAFA_47\n⛱️CHANNEL @mustafaleaks"
    bot.reply_to(message, response)
...
def welcome_start(message):
    ...
    response = f'''❄️𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗗𝗗𝗢𝗦 𝗕𝗢𝗧, {user_name}! 𝗧𝗛𝗜𝗦 𝗜𝗦 𝗛𝗜𝗚𝗛 𝗤𝗨𝗔𝗟𝗜𝗧𝗬 ??𝗘??𝗩𝗘𝗥 𝗕𝗔𝗦𝗘𝗗 𝗗𝗗𝗢𝗦 𝗧𝗢 ??𝗘𝗧 𝗔𝗖𝗖𝗘𝗦𝗦.
